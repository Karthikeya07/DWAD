...
<tr>    <td> Password : </td>    <td> <input type="password" name="pw" size=30 > </td>   </tr>   <tr>    <td align="left" >    <input type="Submit" value="Insert User Details"> &nbsp;&nbsp;  
        <td> <a href="displayusers.php"> Display Users </a>    
        <a style="color:red" href="verifyuser.php"> &nbsp;Existing User Verify </a> </td>
       </td>   </tr>   
<tr>    <td> <a href="updateform.php"> Update Password </td>    <td> <a href="deleteform.php"> Delete User </a> </td>   </tr>  
